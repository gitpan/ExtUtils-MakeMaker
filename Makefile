...
# 6.25_01 (Revision: 1.147) from the contents of
...
#     PREREQ_PM => { DirHandle=>q[0], Pod::Man=>q[0], File::Basename=>q[0], File::Spec=>q[0.8] }
...
PM_TO_BLIB = lib/ExtUtils/MM_VMS.pm \
...
DISTVNAME = ExtUtils-MakeMaker-6.25_01
...
$(INST_SCRIPT)/instmodsh : bin/instmodsh $(FIRST_MAKEFILE) blibdirs.ts
...
realclean purge ::  clean realclean_subdirs
	$(RM_RF) \
	  blib/lib/ExtUtils/MakeMaker/FAQ.pod blib/lib/ExtUtils/MM_VMS.pm \
	  blib/lib/ExtUtils/Installed.pm blib/lib/ExtUtils/Liblist.pm \
	  blib/lib/ExtUtils/testlib.pm blib/lib/ExtUtils/MakeMaker/vmsish.pm \
	  $(MAKEFILE_OLD) blib/lib/ExtUtils/MM_Unix.pm \
	  blib/lib/ExtUtils/MY.pm blib/lib/ExtUtils/MM_Win95.pm \
	  blib/lib/ExtUtils/Command.pm blib/lib/ExtUtils/MM_BeOS.pm \
	  blib/lib/ExtUtils/Mksymlists.pm blib/lib/ExtUtils/MakeMaker.pm \
	  blib/lib/ExtUtils/MakeMaker/bytes.pm blib/lib/ExtUtils/MM_OS2.pm \
	  blib/lib/ExtUtils/MakeMaker/Tutorial.pod blib/lib/ExtUtils/Liblist/Kid.pm \
	  blib/lib/ExtUtils/MM_UWIN.pm blib/lib/ExtUtils/Install.pm \
	  blib/lib/ExtUtils/MANIFEST.SKIP blib/lib/ExtUtils/MM_Any.pm \
	  $(INST_AUTODIR) blib/lib/ExtUtils/MM_NW5.pm \
	  blib/lib/ExtUtils/MM_Cygwin.pm blib/lib/ExtUtils/MM.pm \
	  blib/lib/ExtUtils/Manifest.pm $(DISTVNAME) \
	  blib/lib/ExtUtils/MM_Win32.pm blib/lib/ExtUtils/Command/MM.pm \
	  blib/lib/ExtUtils/MM_MacOS.pm $(FIRST_MAKEFILE) \
	  blib/lib/ExtUtils/Mkbootstrap.pm blib/lib/ExtUtils/Packlist.pm \
	  $(INST_ARCHAUTODIR) blib/lib/ExtUtils/MM_DOS.pm 
...
metafile :
	...
	$(NOECHO) $(ECHO) 'version:      6.25_01' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'generated_by: ExtUtils::MakeMaker version 6.25_01' >> META_new.yml
...
ppd:
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="6,25_01,0,0">' > $(DISTNAME).ppd
