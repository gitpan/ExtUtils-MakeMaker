...
# 6.7705 (Revision: 67705) from the contents of
...
#     INSTALLDIRS => q[site]
#     LICENSE => q[perl]
#     META_MERGE => { resources=>{ MailingList=>q[makemaker@perl.org], homepage=>q[https://metacpan.org/release/ExtUtils-MakeMaker], license=>q[http://dev.perl.org/licenses/], repository=>q[http://github.com/Perl-Toolchain-Gang/ExtUtils-MakeMaker], bugtracker=>q[http://rt.cpan.org/NoAuth/Bugs.html?Dist=ExtUtils-MakeMaker] }, no_index=>{ directory=>[q[bundled], q[my]], package=>[q[DynaLoader], q[in]] } }
#     MIN_PERL_VERSION => q[5.006]
#     NAME => q[ExtUtils::MakeMaker]
#     PMLIBDIRS => [q[lib], q[inc]]
#     PMLIBPARENTDIRS => [q[lib], q[inc]]
#     PREREQ_PM => { File::Spec=>q[0.8], DirHandle=>q[0], Data::Dumper=>q[0], Pod::Man=>q[0], File::Basename=>q[0] }
#     TEST_REQUIRES => {  }
...
# These definitions are from config.sh (via /opt/perl-5.18.1/lib/5.18.1/x86_64-linux/Config.pm).
...
OBJ_EXT = .o
OSNAME = linux
OSVERS = 3.2.0-51-generic
RANLIB = :
SITELIBEXP = /opt/perl-5.18.1/lib/site_perl/5.18.1
SITEARCHEXP = /opt/perl-5.18.1/lib/site_perl/5.18.1/x86_64-linux
SO = so
VENDORARCHEXP = 
VENDORLIBEXP = 
...
DESTDIR = 
PREFIX = $(SITEPREFIX)
PERLPREFIX = /opt/perl-5.18.1
SITEPREFIX = /opt/perl-5.18.1
VENDORPREFIX = 
INSTALLPRIVLIB = /opt/perl-5.18.1/lib/5.18.1
DESTINSTALLPRIVLIB = $(DESTDIR)$(INSTALLPRIVLIB)
INSTALLSITELIB = /opt/perl-5.18.1/lib/site_perl/5.18.1
DESTINSTALLSITELIB = $(DESTDIR)$(INSTALLSITELIB)
INSTALLVENDORLIB = 
DESTINSTALLVENDORLIB = $(DESTDIR)$(INSTALLVENDORLIB)
INSTALLARCHLIB = /opt/perl-5.18.1/lib/5.18.1/x86_64-linux
DESTINSTALLARCHLIB = $(DESTDIR)$(INSTALLARCHLIB)
INSTALLSITEARCH = /opt/perl-5.18.1/lib/site_perl/5.18.1/x86_64-linux
DESTINSTALLSITEARCH = $(DESTDIR)$(INSTALLSITEARCH)
INSTALLVENDORARCH = 
DESTINSTALLVENDORARCH = $(DESTDIR)$(INSTALLVENDORARCH)
INSTALLBIN = /opt/perl-5.18.1/bin
DESTINSTALLBIN = $(DESTDIR)$(INSTALLBIN)
INSTALLSITEBIN = /opt/perl-5.18.1/bin
DESTINSTALLSITEBIN = $(DESTDIR)$(INSTALLSITEBIN)
INSTALLVENDORBIN = 
DESTINSTALLVENDORBIN = $(DESTDIR)$(INSTALLVENDORBIN)
INSTALLSCRIPT = /opt/perl-5.18.1/bin
DESTINSTALLSCRIPT = $(DESTDIR)$(INSTALLSCRIPT)
INSTALLSITESCRIPT = /opt/perl-5.18.1/bin
DESTINSTALLSITESCRIPT = $(DESTDIR)$(INSTALLSITESCRIPT)
INSTALLVENDORSCRIPT = 
DESTINSTALLVENDORSCRIPT = $(DESTDIR)$(INSTALLVENDORSCRIPT)
INSTALLMAN1DIR = /opt/perl-5.18.1/man/man1
DESTINSTALLMAN1DIR = $(DESTDIR)$(INSTALLMAN1DIR)
INSTALLSITEMAN1DIR = /opt/perl-5.18.1/man/man1
DESTINSTALLSITEMAN1DIR = $(DESTDIR)$(INSTALLSITEMAN1DIR)
INSTALLVENDORMAN1DIR = 
DESTINSTALLVENDORMAN1DIR = $(DESTDIR)$(INSTALLVENDORMAN1DIR)
INSTALLMAN3DIR = /opt/perl-5.18.1/man/man3
DESTINSTALLMAN3DIR = $(DESTDIR)$(INSTALLMAN3DIR)
INSTALLSITEMAN3DIR = /opt/perl-5.18.1/man/man3
DESTINSTALLSITEMAN3DIR = $(DESTDIR)$(INSTALLSITEMAN3DIR)
INSTALLVENDORMAN3DIR = 
DESTINSTALLVENDORMAN3DIR = $(DESTDIR)$(INSTALLVENDORMAN3DIR)
PERL_LIB = /opt/perl-5.18.1/lib/5.18.1
PERL_ARCHLIB = /opt/perl-5.18.1/lib/5.18.1/x86_64-linux
LIBPERL_A = libperl.a
FIRST_MAKEFILE = Makefile
MAKEFILE_OLD = Makefile.old
MAKE_APERL_FILE = Makefile.aperl
PERLMAINCC = $(CC)
PERL_INC = /opt/perl-5.18.1/lib/5.18.1/x86_64-linux/CORE
PERL = /opt/perl-5.18.1/bin/perl
FULLPERL = /opt/perl-5.18.1/bin/perl
ABSPERL = $(PERL)
...
PM_TO_BLIB = lib/ExtUtils/Command/MM.pm \
...
DISTVNAME = ExtUtils-MakeMaker-6.77_05
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'generated_by: '\''ExtUtils::MakeMaker version 6.7705, CPAN::Meta::Converter version 2.120351'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'version: 6.77_05' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "generated_by" : "ExtUtils::MakeMaker version 6.7705, CPAN::Meta::Converter version 2.120351",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "version" : "6.77_05"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
