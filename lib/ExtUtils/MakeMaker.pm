# $Id: /local/schwern.org/CPAN/ExtUtils-MakeMaker/trunk/lib/ExtUtils/MakeMaker.pm 3948 2005-03-15T10:02:19.518941Z schwern  $
...
$VERSION = '6.25_11';
($Revision) = q$Revision: 3948 $ =~ /Revision:\s+(\S+)/;
...
MakeMaker object. The following lines will be parsed o.k.:
    ...
    $VERSION = '1.00';
    *VERSION = \'1.01';
    $VERSION = sprintf "%d.%03d", q$Revision: 3948 $ =~ /(\d+)/g;
    $FOO::VERSION = '1.10';
    *FOO::VERSION = \'1.11';
